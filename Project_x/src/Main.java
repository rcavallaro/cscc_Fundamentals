            ...
            switch (userMenuOption) {
                ...
                case "3":
                    ...
                    if (intTaskNumber >= 0 && intTaskNumber < intTaskCount){
                        ...
                        strTaskName[intTaskCount] = userInput("Enter the task's new name: ");
                        strTaskDescription[intTaskCount] = userInput("Enter the task's new description: ");
                        strTaskPriority[intTaskCount] = userInput("Enter the new task's new priority: ");
                ...
                case "4":
                    ...
                    for (int i = 0; i < intTaskCount; i++){
                        System.out.println("Task index: " + i +
                                    ", Name: " + strTaskName[i] +
                                    ", Description: " + strTaskDescription[i] +
                                    ", Priority: " + strTaskPriority[i]);                     }
                    }
                    System.out.println("\n");
                    break;
                case "5":
                    ...
                    System.out.println("\nTasks\n");
                    for (int i = 0; i < intTaskCount; i++){
                        if (strTaskPriority[intTaskCount] = strListTaskPriority){
                            System.out.println("Task index: " + i +
                                    ", Name: " + strTaskName[i] +
                                    ", Description: " + strTaskDescription[i] +
                                    ", Priority: " + strTaskPriority[i]);
